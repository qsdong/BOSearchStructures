# Generated at 2024-02-23 17:34:40
# Qingshu Dong

import numpy as np

def  calF_183(SF,startBasis=0):
    ...
    if 23 in usedBasis:
        ...
        fB221 = 4*sin(2*z*pi)*(cos(4*pi*(2*x - y)) + cos(4*pi*(x + y)) + cos(4*pi*(x - 2*y)))
    ...
    if 30 in usedBasis:
        ...
        fB303 = 4*sin(6*z*pi)*(cos(6*x*pi) + cos(6*y*pi) + cos(6*pi*(x - y)))
